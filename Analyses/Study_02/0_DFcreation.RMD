...
```{r Loading dataframe}
  df.og.el <- read.csv(file = paste0(WorkDir, "/data/Pilot/Deriv/df_subset_eventlevel.csv"), 
                 header = T, sep=",",
                 row.names = 1,
                 stringsAsFactors = F,
                 na.strings=c("","N/A"))
...
Okay, lastly, it may be good to have a person-level dataframe of the new all-combined together data. I'm going to take a similar approach to how I'd constructed this in the pilot. 
