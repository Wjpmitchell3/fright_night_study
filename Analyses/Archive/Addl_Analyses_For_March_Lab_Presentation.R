# This file contains analyses that I'd conducted to try to make the Fright Night findings more relevant to a threat audience (i.e., the March Lab). These were not included in the primary manuscript, were not preregistered, and had not been considered prior to this purpose, so I don't feel very confident about them.
