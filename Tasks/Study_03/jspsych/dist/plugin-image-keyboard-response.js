  ...
  const info = {
      ...
      parameters: {
          ...
          prompt_1: {
              ...
              pretty_name: "Pre-Image Prompt",
              default: null,
          },
          /** Any content here will be displayed below the stimulus. */
          prompt_2: {
              type: jspsych.ParameterType.HTML_STRING,
              pretty_name: "Post-Image Prompt",
              default: null,
          },
  ...
  class ImageKeyboardResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          if (trial.render_on_canvas) {
              ...
              if (trial.prompt_1 !== null) {
                  display_element.insertAdjacentHTML("beforeend", trial.prompt_1);
              }
          }
          else {
            var html = "<br><br><br>";  
            // add pre-image prompt
              if (trial.prompt_1 !== null) {
                 html += trial.prompt_1;
              }
              // display stimulus as an image element
              html += '<img src="' + trial.stimulus + '" id="jspsych-image-keyboard-response-stimulus">';
              // add post-image prompt
                if (trial.prompt_2 !== null) {
                html += trial.prompt_2;
              }
