  ...
  class ImageButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          if (trial.render_on_canvas) {
              // add lower prompt if there is one
              if (trial.lower_prompt !== null) {
                   display_element.insertAdjacentHTML("beforeend", trial.lower_prompt);
              }
            ...
            // add upper prompt
              if (trial.upper_prompt !== null) {
                ...
                html += '<img src="' + trial.stimulus + '" id="jspsych-image-button-response-stimulus"><br><br>';
              //display buttons
              var buttons = [];
              if (Array.isArray(trial.button_html)) {
                  if (trial.button_html.length == trial.choices.length) {
